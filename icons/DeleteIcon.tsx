...
interface DeleteIconProps extends SvgProps {
    strokeColor?: string; // Колір ліній
    fillColor?: string; // Колір заповнення
    size?: number; // Розмір іконки
}

const DeleteIcon = ({ strokeColor = "#232323", fillColor = "#BDBDBD", size = 24, ...props }: DeleteIconProps) => (
    <Svg
        width={size}
        height={size}
        fill="none"
